#Fizzics
> Experiments with the famous physics engine.

[![Build Status](https://travis-ci.org/Timsig/fizzics.svg?branch=master)](https://travis-ci.org/Timsig/fizzics) [![Dependency Status](https://david-dm.org/Timsig/fizzics.svg)](https://david-dm.org/Timsig/fizzics) [![devDependency Status](https://david-dm.org/Timsig/fizzics/dev-status.svg)](https://david-dm.org/Timsig/fizzics#info=devDependencies)
...
## Release History
 * 2015-04-27   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)